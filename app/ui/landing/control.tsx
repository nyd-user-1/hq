...
export default function Control() {
  return (
    <Section id="control">
      <FileChip>lib/repl.ts</FileChip>
      <h2 className="mt-6 max-w-3xl text-3xl font-semibold leading-tight tracking-tight text-zinc-100 sm:text-5xl">
        It doesn&apos;t just watch. It writes back.
      </h2>
      <p className="mt-5 max-w-2xl text-lg leading-relaxed text-zinc-400">
        Type from hq and it lands in the live terminal. <span className="text-zinc-100">No fork. One transcript.</span>{" "}
        Terminal to hq and back — one conversation.
      </p>
