  ...
  return (
    <Section id="control">
      ...
      <div className="mt-14 flex flex-col items-stretch gap-6 lg:flex-row lg:items-center lg:gap-8">
        <div className="relative flex flex-1 items-center rounded-xl border border-dashed border-blue-600 bg-blue-600/[0.06] p-8" style={{ minHeight: 220 }}>
        ...
        <div className="relative flex flex-1 items-center rounded-xl border border-dashed border-orange-500 p-8" style={{ minHeight: 220 }}>
