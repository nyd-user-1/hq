...
// business — backstop prepay is the wedge: hq is free, the wall is not. Every tier
// ends in one clear action.
  ...
  return (
    <Section id="pricing">
      ...
      <h2 className="mt-6 text-3xl font-semibold leading-tight tracking-tight text-zinc-100 sm:text-5xl">
        Open-source core. Prepaid capacity.
      </h2>
      <div className="mt-14 grid gap-6 md:grid-cols-3">
        ...
        <div className="relative flex flex-col rounded-2xl border-2 border-blue-600 bg-blue-600/[0.06] p-8">
          ...
          <div className="font-mono text-xs uppercase tracking-wider text-blue-300">Backstop credit</div>
          <div className="mt-4 text-5xl font-semibold text-zinc-50">
            $25<span className="text-lg font-normal text-zinc-400">+ one-time</span>
          </div>
          <p className="mt-3 text-[15px] leading-relaxed text-zinc-200">
            Prepaid API capacity. Hit the wall, type <code className="rounded bg-zinc-800 px-1 py-0.5 font-mono text-sm">/backstop</code>, keep working.
          </p>
          <ul className="mt-6 flex flex-col gap-2.5 text-[15px] text-zinc-100">
            <Feat>Unfreezes every live session in place</Feat>
            <Feat>Metered at provider list price</Feat>
            <Feat>Draws down only while backstopped</Feat>
          </ul>
          <Link
            href="/checkout"
