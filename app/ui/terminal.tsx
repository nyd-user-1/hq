...
// The session, graduated out of the terminal: verbatim last exchanges from the
// live transcript, plus an input that continues the conversation via
// `claude -p --resume`. Renders directly inside page.tsx's boundary — no nested
// chip — so the Dashboard column reads as a single clean peer of @activity /
// @console, matching the Vercel parallel-routes demo.
