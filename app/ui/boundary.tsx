...
export default function Boundary({
  ...
  return (
    <div className="boundary-flash relative flex min-h-0 min-w-0 flex-1 flex-col gap-4 rounded-lg border border-dashed border-zinc-700 p-4 pt-7 sm:p-5 sm:pt-7">
      <span className="boundary-flash-chip absolute -top-2.5 left-4 max-w-[calc(100%-2rem)] truncate bg-zinc-800 px-2 py-0.5 font-mono text-[10px] uppercase tracking-widest text-zinc-400">
        {label}
      </span>
      {children}
    </div>
