          ...
          <PaneDropZone key={tok} slot={slot} className="flex min-w-0 flex-1 flex-col">
            ...
            >
              <Link
                ...
                className="boundary-flash-chip absolute -top-2.5 right-3 z-20 flex shrink-0 items-center bg-zinc-800 px-1.5 py-0.5 text-zinc-400 transition-colors hover:text-zinc-100"
              >
