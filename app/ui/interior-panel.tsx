...
// INTERIOR-PANEL — the FIRST kpi library drawer (saved as a record / reusable
// "interior" panel variant). It lives INSIDE a view (a flex sibling column), not
// at the root: a self-contained card list with search. The shipped metric library
// is now kpi-panel.tsx (the skills-panel root push-in standard); this kept the
// original card design, which kpi-panel reuses. Mount it where you want an in-view
// library: <InteriorPanel catalog={…} placed={…} onAdd onRemove onClose />.
