 ...
 */
export async function preflight(state) {
  const driver =
    { bedrock: viaBedrockClassic, "bedrock-mantle": viaMantle, anthropic: viaAnthropicApi }[
      state.provider
    ] ?? viaBedrockClassic;
  ...
  try {
    const r = await driver(req, sinkResponse(), body, state);
